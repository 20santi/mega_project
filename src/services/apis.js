...
export const profileEndpoints = {
  ...
  GET_INSTRUCTOR_DATA_API: BASE_URL + "/profiles/instructorDashboard",
}
...
export const settingsEndpoints = {
  UPDATE_DISPLAY_PICTURE_API: BASE_URL + "/profiles/updateDisplayPicture",
  UPDATE_PROFILE_API: BASE_URL + "/profiles/updateProfile",
  CHANGE_PASSWORD_API: BASE_URL + "/auth/changepassword",
  DELETE_PROFILE_API: BASE_URL + "/profiles/deleteProfile",
}